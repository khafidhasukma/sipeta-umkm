        ...
        @else
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <p class="text-sm font-medium text-gray-900">{{ $profile->nama_usaha }}</p>
                        </div>
                        <div>
                            <p class="text-sm text-gray-500 mb-1">Jenis Usaha</p>
                            <p class="text-sm font-medium text-gray-900">{{ ucwords($profile->jenis_usaha) }}</p>
                        </div>
                        <div>
                            <p class="text-sm text-gray-500 mb-1">NIB</p>
                            <p class="text-sm font-mono font-medium text-gray-900">{{ $user->nib }}</p>
                        </div>
                        <div>
                            <p class="text-sm text-gray-500 mb-1">Kecamatan</p>
                            <p class="text-sm font-medium text-gray-900">{{ ucwords($profile->kecamatan) }}</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="mt-8">
                ...
                <div class="bg-gradient-to-r from-green-50 to-teal-50 rounded-xl p-6 border border-green-100 flex items-center justify-between">
                    ...
                    <a href="{{ route('umkm.collaboration') }}" class="px-5 py-2.5 bg-white text-green-700 font-medium rounded-lg shadow-sm hover:bg-green-50 transition-colors border border-green-200">
                        Lihat Peluang
                    </a>
                </div>
            </div>
