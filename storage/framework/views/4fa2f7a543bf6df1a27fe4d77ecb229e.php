...
<?php $__env->startSection('title', 'Bahan Baku'); ?>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex items-center justify-end space-x-2">
                                        <button @click="openEdit(<?php echo e(json_encode($material)); ?>, '<?php echo e(route('umkm.raw-materials.update', $material->id)); ?>')" class="p-2 text-blue-600 hover:bg-blue-50 rounded-lg transition-colors" title="Edit">
...
<?php echo $__env->make('layouts.umkm', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\sipeta-umkm\resources\views/umkm/raw-materials.blade.php ENDPATH**/ ?>