...
<?php $component->withAttributes([]); ?>
        ...
        <div 
            x-data="{
                map: null,
                mapData: <?php echo \Illuminate\Support\Js::from($mapData)->toHtml() ?>,
                markers: [],
                polygons: [],
                totalUmkm: 0,
                leafletLoaded: false,
        ...
        >
            ...
            <div 
                x-ref="mapContainer" 
                id="umkm-map-<?php echo e($this->getId()); ?>" 
...
<?php endif; ?><?php /**PATH D:\laragon\www\sipeta-umkm\resources\views/filament/widgets/umkm-distribution-map.blade.php ENDPATH**/ ?>