...
<?php $__env->startSection('title', 'Peta Persebaran UMKM'); ?>
...
<style>
    ...
    <?php if(request()->has('admin') && auth()->check() && auth()->user()->role === 'admin'): ?>
    #map {
...
<script>
    ...
    async function loadUmkmData() {
        try {
            const response = await fetch('<?php echo e(route('map.data')); ?>');
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make(request()->has('admin') && auth()->check() && auth()->user()->role === 'admin' ? 'layouts.admin' : 'layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\sipeta-umkm\resources\views/map/index.blade.php ENDPATH**/ ?>