...
<?php $__env->startSection('title', 'Monitoring Alat Produksi'); ?>
<?php $__env->startSection('page-title', 'Monitoring Alat Produksi'); ?>
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <h3 class="text-3xl font-bold text-gray-900 mt-2"><?php echo e($alatPerKecamatan->sum('total_alat')); ?></h3>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <h3 class="text-3xl font-bold text-gray-900 mt-2"><?php echo e($alatPerKecamatan->sum('jenis_alat')); ?></h3>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <h3 class="text-3xl font-bold text-gray-900 mt-2"><?php echo e($bahanPerKecamatan->sum('jenis_bahan')); ?></h3>
    ...
    <div class="overflow-x-auto">
        <table class="w-full">
            ...
            <tbody class="divide-y divide-gray-200">
                <?php $__empty_1 = true; $__currentLoopData = $alatPerKecamatan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr class="hover:bg-gray-50">
                    <td class="px-6 py-4">
                        <div class="text-sm font-medium text-gray-900"><?php echo e($data->kecamatan); ?></div>
                    </td>
                    <td class="px-6 py-4">
                        <div class="text-sm text-gray-600 max-w-xs truncate" title="<?php echo e($data->daftar_alat); ?>">
                            <?php echo e($data->daftar_alat ?: 'Tidak ada data'); ?>

                        </div>
                    </td>
                    <td class="px-6 py-4 text-right">
                        <span class="text-sm font-bold text-blue-600"><?php echo e($data->jenis_alat); ?></span>
                    </td>
                    <td class="px-6 py-4 text-right">
                        <span class="text-sm font-bold text-orange-600"><?php echo e($data->total_alat); ?></span>
                    </td>
                    <td class="px-6 py-4 text-center">
                        <?php if($data->total_alat >= 10): ?>
                            <span class="px-3 py-1 text-xs font-medium bg-green-100 text-green-800 rounded-full">Tinggi</span>
                        <?php elseif($data->total_alat >= 5): ?>
...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
    ...
    <div class="overflow-x-auto">
        <table class="w-full">
            ...
            <tbody class="divide-y divide-gray-200">
                <?php $__empty_1 = true; $__currentLoopData = $recentTools; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tool): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr class="hover:bg-gray-50">
                    <td class="px-6 py-4">
                        <div class="text-sm font-medium text-gray-900"><?php echo e($tool->nama_alat); ?></div>
                        <div class="text-xs text-gray-500"><?php echo e($tool->jenis); ?></div>
                    </td>
                    <td class="px-6 py-4">
                        <div class="text-sm text-gray-900"><?php echo e($tool->nama_usaha); ?></div>
                    </td>
                    <td class="px-6 py-4">
                        <div class="text-sm text-gray-600"><?php echo e($tool->kecamatan); ?></div>
                    </td>
                    <td class="px-6 py-4">
                        ...
                        <?php else: ?>
                            <span class="px-2 py-1 text-xs font-medium bg-red-100 text-red-800 rounded-full"><?php echo e(ucfirst($tool->kondisi)); ?></span>
                        <?php endif; ?>
                    </td>
                    <td class="px-6 py-4">
                        <div class="text-sm text-gray-600"><?php echo e(\Carbon\Carbon::parse($tool->created_at)->diffForHumans()); ?></div>
                    </td>
                </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <tr>
...
new Chart(distributionCtx, {
    type: 'bar',
    data: {
        labels: <?php echo json_encode($alatPerKecamatan->pluck('kecamatan')); ?>,
        datasets: [{
            label: 'Total Alat',
            data: <?php echo json_encode($alatPerKecamatan->pluck('total_alat')); ?>,
...
new Chart(topToolsCtx, {
    type: 'horizontalBar',
    data: {
        labels: <?php echo json_encode($topAlat->pluck('nama_alat')); ?>,
        datasets: [{
            label: 'Jumlah',
            data: <?php echo json_encode($topAlat->pluck('total')); ?>,
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\sipeta-umkm\resources\views/admin/monitoring-alat.blade.php ENDPATH**/ ?>